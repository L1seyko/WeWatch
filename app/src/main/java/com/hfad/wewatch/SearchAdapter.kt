...
class SearchAdapter(var movieList: List<Movie>, var context: Context, var listener: RecyclerItemListener) : RecyclerView.Adapter<SearchAdapter.SearchMoviesHolder>() {
